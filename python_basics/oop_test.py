...
PHRASES = {
    ...
    "class %%%(object):\n\tdef ***(self, @@@)":
     "Klasa %%% ma funkcje, która przyjmuje parametry self i @@@.",
    "*** = %%%()":
...
#Czy chcemy poćwiczyć najpierw wyrazenia
...
def convert(snnipet, phrase):
    ...
    for sentence in snnipet, phrase:
        result = sentence[:]
...
#kontynuujemy, az uzytkownik nie wciśnie Ctrl + D(lub Ctrl + Z w systemie Windows)
try:
    while True:
