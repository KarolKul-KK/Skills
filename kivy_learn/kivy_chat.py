...
class Scrollablelabel(ScrollView):
    def __init__(self, **kwargs):
        ...
        self.scrool_to_point = Label()
        
        self.layout.add_widget(self.chat_history)
        self.layout.add_widget(self.scrool_to_point)
    ...
    def update_chat_history(self, message):
        ...
        self.scroll_to(self.scrool_to_point)
...
class ChatPage(GridLayout):
    ...
    def on_key_down(self, instance, keyboard, keycode, text, midifiers):
        if keycode == 40:
